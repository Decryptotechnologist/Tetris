...
public class LoseMenu extends Menu {
    ...
    private final int menuImageW = Tetris.getMainWidth()+12;
    
    /**menuImageH variable of LoseMenu*/
    private final int menuImageH = Tetris.getMainHeight();
    ...
    private final int loseTxtX = 144;
    ...
    */
    ...
    public void tick(Game game, boolean up, boolean down, boolean left, boolean right, boolean fire) {
        ...
        if (LMTimer == 0) {
            ...
            Game.level = new Level(1, Tetris.getMainWidth(), Tetris.getMainHeight());
