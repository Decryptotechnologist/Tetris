...
//    private Configuration config;
    ...
    */
    ...
    private void initComponents() {
        ...
        lgePanelSize = new Dimension(Tetris.getMainWidth() - 40, Tetris.getMainHeight() - 20);
        ...
        mainPanel = new JPanel(){
            ...
            protected void paintComponent(Graphics g) {
                ...
                g.drawImage(mainPanelImage, 0, -10, Tetris.getMainWidth() - 40, Tetris.getMainHeight() - 20, null);
            }
        };
...
//        jCheckBox16.setOpaque(false);
        ...
        Tetris.optionsWindow.add(mainPanel);
    ...
    */
    ...
    public void tick(Game game, boolean up, boolean down, boolean left, boolean right, boolean fire) {
        ...
        if(OMfirstTick) {
            ...
            Tetris.addOptions();
            Tetris.setStatusBar("Options Menu");
            Tetris.optionsWindow.validate();
...
//    }
    ...
    */
    ...
    private void restoreDefBtnMouseEntered(MouseEvent evt) {  
        ...
        Tetris.setStatusBar("Restore Defaults");
    }                                     
    ...
    private void backBtnMouseEntered(MouseEvent evt) {                                      
        ...
        Tetris.setStatusBar("Back to Main Menu");
    }                                     
    ...
    private void defineBtnMouseEntered(MouseEvent evt) {
        ...
        Tetris.setStatusBar("Define Keys");
    }                                     
    ...
    private void defineKeys() {
        ...
        game.setMenu(null);
        game.stateManager.setState("menu");
        Tetris.setStatusBar("Define Keys Menu");
    }
    ...
    private void defKeysBtnMouseEntered(MouseEvent evt) {
        ...
        Tetris.setStatusBar("Default Keys");
    }                                     
